...
namespace WpfTodoListApp
{
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        // async시 Task가 리턴값이지만 버튼 클릭 이벤트 메서드와 연결시는 Task -> void로 변경해줘야 연결 가능
        private async void BtnIsert_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            try
            {
        ...
        private async void BtnDelte_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            try
            {
