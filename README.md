...
- 화면 구성
    - 홈 화면
        ...
        <img src="./코딩테스트/코테 이미지/홈 화면.png" width="600">
        
    - 자유게시판 기본 화면

        <img src="./코딩테스트/코테 이미지/기본 화면.png" width="600">
    ...
    1. `게시글 목록` 화면
        ...
        - `검색 기능` 
            ...
            - **부분 일치** 검색 가능 (예 : `자유게시판` 입력 -> `자유게시판`, `자유게시판1` 검색됨)


        <img src="./코딩테스트/코테 이미지/검색화면-부분검색.png" width="600">
    ...
    2. 게시글 상세 화면
        ...
        <img src="./코딩테스트/코테 이미지/내용.png" width="600">
    ...
    3. 게시글 작성 화면
        ...
        <img src="./코딩테스트/코테 이미지/게시글작성.png" width="600">
